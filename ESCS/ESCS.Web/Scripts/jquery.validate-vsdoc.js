...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		/// <summary>
		/// ModiESCS default settings for validation.
	...
	addMethod: function(name, method, message) {
		...
		/// </summary>
		/// <param name="name" type="String">
		/// The name of the method, used to identiESCS and referencing it, must be a valid javascript
		/// identifier
		/// </param>
...
;(function($) {
	...
	// TODO veriESCS if jQuery 1.4's implementation is compatible with older jQuery special-event APIs
