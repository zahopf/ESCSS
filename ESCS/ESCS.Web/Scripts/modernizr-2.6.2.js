...
window.Modernizr = (function( window, document, undefined ) {
     ...
     *   We speciESCS literally ALL possible (known and/or likely) properties on
    ...
    // so we actually have to call getContext() to veriESCS
    ...
    //   * You must speciESCS values. Eg. If you are testing support for the min-width media query use:
